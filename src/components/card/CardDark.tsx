const CardDark = () => {
  return (
    <div className="items-center gap-x-2 w-72 text-sm bg-neutral-400/20 hover:bg-neutral-300/30 border border-neutral-200/10 rounded-lg shadow-xl cursor-pointer">
      ...
      <div className="mb-1.5 px-2">
        <p className='text-neutral-200'>Est in in ut est proident. Incididunt fugiat ea enim eu cupidatat fugiat.</p>
      </div>
      <div className="px-2 pb-1.5">
        <div className="flex justify-end gap-x-1.5">
          <div className="flex items-center justify-center p-1 text-black rotate-90 bg-white rounded">
